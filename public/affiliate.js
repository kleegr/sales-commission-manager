...
(()=>{
 ...
 if(typeof Response!=='undefined'){const json=Response.prototype.json;Response.prototype.json=function(...args){const url=this.url;return json.apply(this,args).then(body=>{observe(url,body);return body;});};}
