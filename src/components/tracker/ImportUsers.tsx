...
export default function ImportUsers({onClose,onSaved}:{onClose:()=>void;onSaved:(count:number)=>void}){
 ...
 <p className="st-help">Choose the sub-account users who will sell for you. Importing adds a salesman profile; it does not grant app access or change their Kleeger permissions. Existing salesmen are marked below.</p>
