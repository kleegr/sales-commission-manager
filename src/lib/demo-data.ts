...
function makeClients(): ClientSeed[] {
  return [
    { id: "cl_acme", companyName: "Acme Corp", contactName: "Wile E.", email: "ops@acme.test", phone: "(555) 111-0001", salespersonId: "sp_jordan", signupDate: "2025-09-05", setupFee: 2500, monthlySubscription: 250, status: "active", notes: "", paidMonths: 99 },
    { id: "cl_globex", companyName: "Globex", contactName: "Hank S.", email: "it@globex.test", phone: "(555) 111-0002", salespersonId: "sp_jordan", signupDate: "2025-11-12", setupFee: 2500, monthlySubscription: 300, status: "active", notes: "", paidMonths: 99 },
    { id: "cl_initech", companyName: "Initech", contactName: "Peter G.", email: "tps@initech.test", phone: "(555) 111-0003", salespersonId: "sp_jordan", signupDate: "2026-02-20", setupFee: 2000, monthlySubscription: 250, status: "active", notes: "", paidMonths: 99 },
    { id: "cl_umbrella", companyName: "Umbrella LLC", contactName: "Alice M.", email: "admin@umbrella.test", phone: "(555) 111-0004", salespersonId: "sp_riley", signupDate: "2025-10-01", setupFee: 1500, monthlySubscription: 200, status: "active", notes: "", paidMonths: 99 },
    { id: "cl_soylent", companyName: "Soylent Foods", contactName: "Joe C.", email: "hello@soylent.test", phone: "(555) 111-0005", salespersonId: "sp_riley", signupDate: "2026-01-15", setupFee: 1500, monthlySubscription: 200, status: "active", notes: "", paidMonths: 99 },
    { id: "cl_stark", companyName: "Stark Industries", contactName: "Pepper P.", email: "billing@stark.test", phone: "(555) 111-0006", salespersonId: "sp_morgan", signupDate: "2026-04-10", setupFee: 3000, monthlySubscription: 350, status: "active", notes: "", paidMonths: 99 },
    { id: "cl_wayne", companyName: "Wayne Enterprises", contactName: "Lucius F.", email: "ap@wayne.test", phone: "(555) 111-0007", salespersonId: "sp_morgan", signupDate: "2025-12-01", setupFee: 3000, monthlySubscription: 300, status: "canceled", notes: "Churned after 3 months.", paidMonths: 3 },
    { id: "cl_hooli", companyName: "Hooli", contactName: "Gavin B.", email: "ops@hooli.test", phone: "(555) 111-0008", salespersonId: "sp_jordan", signupDate: "2026-03-01", setupFee: 2200, monthlySubscription: 275, status: "paused", notes: "Paused billing while migrating.", paidMonths: 2 },
  ];
}
