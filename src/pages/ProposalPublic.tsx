...
export default function ProposalPublic(){
  ...
  return <main className="proposal-presentation">
    ...
    {doc&&<div className="proposal-document-wrap">
      <ProposalSheet title={doc.title} sections={doc.sections} branding={doc.branding} items={doc.lineItems} currency={doc.amount.currency} digits={doc.digits} recipient={doc.recipient} preparedBy={doc.salesperson?.name} sentAt={doc.sentAt} expiresAt={doc.expiresAt}/>
