...
export default function CompanyUsers(){
  ...
  return <div className="st-page company-users">
    ...
    <section className="company-users-panel" aria-label="Company users">
      ...
      {!loading&&data&&<><div className="st-table-wrap"><table className="st-table"><thead><tr><th>User</th><th>App role</th><th>Salesman status</th><th>GoHighLevel role</th><th>Source</th><th>Actions</th></tr></thead><tbody>{visible.map(u=><tr key={u.key}>
