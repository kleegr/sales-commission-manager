  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        card: "0 1px 3px 0 rgb(16 24 40 / 0.04), 0 10px 30px -12px rgb(16 24 40 / 0.12)",
        dropdown: "0 4px 6px -2px rgb(16 24 40 / 0.03), 0 16px 32px -8px rgb(16 24 40 / 0.14)",
        modal: "0 8px 8px -4px rgb(16 24 40 / 0.03), 0 24px 48px -12px rgb(16 24 40 / 0.18)",
      },
      fontFamily: {
